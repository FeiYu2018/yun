	...
	$.fn.jQCloud = function(word_array, options) {
		...
		var drawWordCloud = function() {
			...
			var drawOneWord = function(index, word) {
				...
				if (word_array.length<12){
					word_span = $('<span>').attr(word.html).append("<img src=" + word.text +" width='150' />");
				}else if(word_array.length<24){
					word_span = $('<span>').attr(word.html).append("<img src=" + word.text +" width='120' />");
				} else{
					word_span = $('<span>').attr(word.html).append("<img src=" + word.text +" width='80' />");
				}
